...
describe("RandomCities", () => {
  it("should render a statement", () => {
    ...
    render(<RandomCities cityList={cityList} setIsLoading={setIsLoading} />, {
  ...
  it("should render all city images on page load", () => {
    ...
    const rochester = screen.getByRole("img", {
      name: /Rochester, New York skyline/,
    })
    const cleveland = screen.getByRole("img", {
      name: /Cleveland, Ohio skyline/,
    })
    const sanSalvador = screen.getByRole("img", {
      name: /San Salvador, El Salvador skyline/,
    })
    const kingston = screen.getByRole("img", {
      name: /Kingston, Jamaica skyline/,
    })
